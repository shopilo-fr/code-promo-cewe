#!/usr/bin/env python3
"""
Recuperation des codes promo CEWE depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/cewe.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/cewe.fr"
STORE_NAME = "CEWE"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour CEWE depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-cewe)"
    }
    try:
